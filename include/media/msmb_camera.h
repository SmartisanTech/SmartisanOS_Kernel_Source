...
#define MSM_CAMERA_MSM_AF_TRIGGER_NOTIFY (MSM_CAMERA_EVENT_MIN + 8)
#define MSM_CAMERA_MSM_AF_FINISH_NOTIFY (MSM_CAMERA_EVENT_MIN + 9)
#define MSM_CAMERA_EVENT_MAX    (MSM_CAMERA_EVENT_MIN + 10)
...
#define MSM_CAMERA_PRIV_AF_NOTIFY \
	(V4L2_CID_PRIVATE_BASE + 14)
