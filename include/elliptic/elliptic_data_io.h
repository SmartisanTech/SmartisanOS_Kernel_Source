...
#define ELLIPTIC_WAKEUP_TIMEOUT 2000
...
#define ELLIPTIC_ULTRASOUND_PARAM_ID_DIAGNOSTICS_DATA     16
...
int elliptic_data_push(const char *buffer, size_t buffer_size, elliptic_data_push_t);
