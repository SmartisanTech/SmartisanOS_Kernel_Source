...
void regulator_alwayson_set(struct regulator *regulator);
void regulator_alwayson_unset(struct regulator *regulator);
...
static inline void regulator_alwayson_set(struct regulator *regulator)
{
	return;
}

static inline void regulator_alwayson_unset(struct regulator *regulator)
{
	return;
}
