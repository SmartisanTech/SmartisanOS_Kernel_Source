				     ...
				     int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		/* CCM1007 update cdc-vdd-3v3-supply voltage to 3.7V */
		msm_cdc_update_supply(tavil->wcd9xxx->dev,
							tavil->wcd9xxx->supplies,
							pdata->regulator,
							pdata->num_supplies,
							"cdc-vdd-3v3",
							1);
	...
	case SND_SOC_DAPM_POST_PMD:
		...
		/* CCM1007 update cdc-vdd-3v3-supply voltage to 3.3V */
		msm_cdc_update_supply(tavil->wcd9xxx->dev,
							tavil->wcd9xxx->supplies,
							pdata->regulator,
							pdata->num_supplies,
