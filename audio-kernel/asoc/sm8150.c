...
/* CCM0016 is not stereo spkr, so change channel to one */
...
static struct wcd_mbhc_config wcd_mbhc_cfg = {
	.read_fw_bin = false,
	.calibration = NULL,
	/* CCM0007 do not detect extn_cable */
	.detect_extn_cable = false,
	.mono_stero_detection = false,
	.swap_gnd_mic = NULL,
	.hs_ext_micbias = true,
	/* CCM0007 add the save key (start)*/
	.key_code[0] = KEY_MEDIA,
	.key_code[1] = KEY_VOLUMEUP,
	.key_code[2] = KEY_VOLUMEDOWN,
	.key_code[3] = KEY_SAVE,
	/* CCM0007 add the save key (end)*/
	.key_code[4] = 0,
	.key_code[5] = 0,
	.key_code[6] = 0,
	.key_code[7] = 0,
	/* CCM0007 do not detect lineout devices */
	.linein_th = 0,
	.moisture_en = true,
...
static struct snd_soc_dai_link msm_common_misc_fe_dai_links[] = {
	...
	/* CCM0003 Start: used for smartPA */
	{
...
static struct snd_soc_dai_link msm_mi2s_be_dai_links[] = {
	...
	/* CCM0003 Start: Integrated AW8898 SmartPA */
