...
BUILD_ROOT_RELATIVE := $(ANDROID_BUILD_TOP)/
...
$(GEN): $(KERNEL_USR)
$(GEN): $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr
$(GEN): PRIVATE_PATH := $(MYLOCAL_PATH)
$(GEN): PRIVATE_CUSTOM_TOOL = $(shell cd $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ; $(BUILD_ROOT_RELATIVE)$(HEADER_INSTALL_DIR)/headers_install.sh $(BUILD_ROOT_RELATIVE)$(dir $@) $(BUILD_ROOT_RELATIVE)$(subst $(UAPI_OUT),$(MYLOCAL_PATH),$(dir $@)) $(notdir $@))
