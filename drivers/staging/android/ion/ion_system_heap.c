...
/* modified based on ion_system_heap_debug_show() */
unsigned long ion_system_heap_cached(struct ion_heap *heap)
{
	...
	return uncached_total + cached_total + secure_total;
}
