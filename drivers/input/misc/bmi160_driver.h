...
/*! bmi160 sensor status when suspend */
struct sensor_status_suspend 
{
      u8 acc_status;
      u8 gyro_status;
      u8 mag_status;
...
struct bmi_client_data {
	...
	struct pw_mode pw;
	struct sensor_status_suspend sensor_status;
	struct regulator *bmi_vdd;
	struct regulator *bmi_vio;
	u8 bmi_pm_status;
	struct odr_t odr;
