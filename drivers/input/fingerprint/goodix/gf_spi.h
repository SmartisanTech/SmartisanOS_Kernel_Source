...
#define GF_NAV_INPUT_LEFT		SLIDE_LEFT //KEY_LEFT
//#define GF_NAV_INPUT_RIGHT		KEY_RIGHT
#define GF_NAV_INPUT_RIGHT		SLIDE_RIGHT
#define GF_NAV_INPUT_CLICK		KEY_BACK //KEY_VOLUMEDOWN
#define GF_NAV_INPUT_DOUBLE_CLICK	KEY_MENU //KEY_VOLUMEUP
#define GF_NAV_INPUT_LONG_PRESS		KEY_HOMEPAGE
