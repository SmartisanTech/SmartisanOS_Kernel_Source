...
#define CONFIG_GTP_HAVE_TOUCH_KEY	1
#define CONFIG_GTP_INT_SEL_SYNC		1
#define CONFIG_GTP_POWER_CTRL_SLEEP	1
#define CONFIG_GTP_ESD_PROTECT		1
#define CONFIG_GTP_AUTO_UPDATE		1
#define CONFIG_GTP_SYSFS_NODE_EN	1

#ifdef CONFIG_GTP_HAVE_TOUCH_KEY
#define GTP_KEY_TAB	 {KEY_APPSELECT, KEY_HOMEPAGE, KEY_BACK}
...
extern int gt1x_pwr_gpio;
#define GTP_RST_PORT gt1x_rst_gpio
#define GTP_INT_PORT gt1x_int_gpio
#define GTP_PWR_PORT gt1x_pwr_gpio
#else
#define GTP_RST_PORT	99
#define GTP_INT_PORT	125
#define GTP_PWR_PORT	0
#endif
