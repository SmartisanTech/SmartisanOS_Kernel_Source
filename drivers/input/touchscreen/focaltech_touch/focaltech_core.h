...
struct fts_ts_data {
	...
	struct touch_classdev touchscreen;
#endif
#if FTS_REPORT_MAJOR_EN
	bool report_touch_major;
#endif
#if FTS_REPORT_MINOR_EN
	bool report_touch_minor;
#endif
};
...
/* Glove functions */
int fts_glove_mode_set(u8 value);
int fts_glove_mode_get(void);
