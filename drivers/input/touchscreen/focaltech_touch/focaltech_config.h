 ...
 */
//#0244395 bsp madan@smartisan.com add to remove unnecessary begin.
 #define FTS_DEBUG_EN                            0
//#0244395 bsp madan@smartisan.com add to remove unnecessary end.
/*
...
/*
 * upgrade all bin, include tp bootloader.
 */
#define FTS_UPGRADE_ALL_BIN			0
...
#if FTS_UPGRADE_ALL_BIN
/*
 * FW.i file for auto upgrade, you must replace it with your own
 * define your own fw_file, the sample one to be replaced is invalid
 * NOTE: if FTS_GET_VENDOR_ID_NUM > 1, it's the fw corresponding with FTS_VENDOR_ID
 */
#define FTS_UPGRADE_FW_FILE                      "include/firmware/Smartisan_Ocean_FT3518_GVO_Ver0x19_20180612_all.i"

/*
 * if FTS_GET_VENDOR_ID_NUM >= 2, fw corrsponding with FTS_VENDOR_ID2
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW2_FILE                     "include/firmware/Smartisan_Ocean_FT3518_GVO_Ver0x19_20180612_all.i"

/*
 * if FTS_GET_VENDOR_ID_NUM >= 3, fw corrsponding with FTS_VENDOR_ID3
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW3_FILE                     "include/firmware/Smartisan_Ocean_FT3518_GVO_Ver0x19_20180612_all.i"
#else
#define FTS_UPGRADE_FW_FILE                      "include/firmware/Smartisan_Ocean_FT3518_GVO_Ver0x23_20180716_app.i"
#define FTS_UPGRADE_FW2_FILE                     "include/firmware/Smartisan_Ocean_FT3518_GVO_Ver0x23_20180716_app.i"
#define FTS_UPGRADE_FW3_FILE                     "include/firmware/Smartisan_Ocean_FT3518_GVO_Ver0x23_20180716_app.i"
#endif
/*********************************************************/
