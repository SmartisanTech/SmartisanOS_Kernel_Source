 ...
 */
#if defined(CONFIG_TOUCHSCREEN_FTS_LOG)
...
/*
 * Report Major in multitouch
 * 1:enable(default),0:disable
 */
#ifdef CONFIG_FACTORY_SUPPORT
#define FTS_REPORT_MAJOR_EN			0
#else
#define FTS_REPORT_MAJOR_EN			1
#endif

/*
 * Report Minor in multitouch
 * 1:enable(default),0:disable
 */
#ifdef CONFIG_FACTORY_SUPPORT
#define FTS_REPORT_MINOR_EN			0
#else
#define FTS_REPORT_MINOR_EN			1
#endif

#if defined(CONFIG_TOUCHSCREEN_FTS_FOD) && !defined(CONFIG_FACTORY_SUPPORT)
#define TOUCHSCREEN_FTS_FOD_EN
#endif
 ...
 */
#ifdef CONFIG_FACTORY_SUPPORT
#define FTS_SHUTDOWN_EN				0
#else
#define FTS_SHUTDOWN_EN				1
#endif
