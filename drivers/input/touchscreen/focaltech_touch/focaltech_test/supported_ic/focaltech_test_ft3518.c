...
test_err:
	if (result) {
		*test_result = true;
		...
		FTS_TEST_INFO("=======> rawdata test PASS\n");
	} else {
		*test_result = false;
		FTS_TEST_SAVE_INFO("------ rawdata test NG\n");
		FTS_TEST_ERROR("=======> rawdata test NG\n");
	}
...
test_err:
	if (tmp_result && tmp2_result) {
		*test_result = true;
		FTS_TEST_SAVE_INFO("\n------ scap cb test PASS\n");
		FTS_TEST_INFO("=======> scap cb test PASS\n");
	} else {
		*test_result = false;
		FTS_TEST_SAVE_ERR("\n------ scap cb test NG\n");
		FTS_TEST_ERROR("=======> scap cb test NG\n");
	}
...
test_err:
	if (tmp_result && tmp2_result) {
		*test_result = true;
		...
		FTS_TEST_INFO("=======> scap rawdata test PASS\n");
	} else {
		*test_result = false;
		FTS_TEST_SAVE_INFO("\n------ scap rawdata test NG\n");
		FTS_TEST_ERROR("=======> scap rawdata test NG\n");
	}
...
test_err:
	...
	if (tmp_result) {
		*test_result = true;
		...
		FTS_TEST_INFO("=======> panel differ test PASS\n");
	} else {
		*test_result = false;
		FTS_TEST_SAVE_ERR("------ panel differ test NG\n");
		FTS_TEST_ERROR("=======> panel differ test NG\n");
	}
