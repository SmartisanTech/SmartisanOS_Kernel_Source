...
*****************************************************************************/
//#0244395 bsp madan@smartisan.com add to store factory test result begin
#define FTS_INI_FILE_PATH_READ               "/vendor/etc/"
#define FTS_INI_FILE_PATH_WRIGHT             "/data/local/tmp/"
//#0244395 bsp madan@smartisan.com add to store factory test result end
