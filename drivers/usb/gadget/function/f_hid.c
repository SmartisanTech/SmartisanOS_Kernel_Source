...
static struct usb_function *hidg_alloc(struct usb_function_instance *fi)
{
	...
	mutex_lock(&opts->lock);
	++opts->refcnt;
	opts->subclass = my_hid_data.subclass;
	opts->protocol = my_hid_data.protocol;
	opts->report_length = my_hid_data.report_length;
	opts->report_desc_length = my_hid_data.report_desc_length;
	opts->report_desc = my_hid_data.report_desc;
