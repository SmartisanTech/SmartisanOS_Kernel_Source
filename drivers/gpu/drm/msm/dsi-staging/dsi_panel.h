...
#define BL_GAP 15
static u32 gamma_lumen[] = {
	// curve1
	// 1, 60, 133, 256, 439, 724, 1129, 1427, 1563, 1750, 2047
	//curve2
	// 1, 60, 115, 223, 378, 575, 833, 1140, 1423, 1723, 2047
	//curve3
	11, 62, 109, 175, 285, 424, 620, 860, 1163, 1580, 2047
};

static u32 dc_gamma_lumen[] = {
	40, 62, 109, 175, 285, 424, 620, 860, 1163, 1580, 2047
};
...
enum dsi_panel_ie_level {
	DSI_PANEL_IE_CAM_TEMP_ON          =   8,
	DSI_PANEL_IE_EYE_PROTECT_ENTER    =  10,
	DSI_PANEL_IE_SET_COLOR_RESUME     =  12,
	DSI_PANEL_IE_SET_CT_RESET         =  14,
	DSI_PANEL_IE_EYE_PROTECT_EXIT     =  18,
	DSI_PANEL_IE_SET_SOURCE_ENTER     =  20,
	DSI_PANEL_IE_SET_SOURCE_EXIT      =  21,
	DSI_PANEL_IE_SET_LP_ENTER         =  60,
	DSI_PANEL_IE_SET_LP_EXIT          =  61,
	DSI_PANEL_IE_SET_BACKLIGHT_TO_MAX_ENTER =  68,
	DSI_PANEL_IE_SET_BACKLIGHT_TO_MAX_EXIT  =  69,
	DSI_PANEL_IE_SET_LOCAL_HBM_ENTER  =  70,
	DSI_PANEL_IE_SET_LOCAL_HBM_EXIT   =  71,
	DSI_PANEL_IE_SET_WEAK_SRE         =  92,
	DSI_PANEL_IE_SET_MIDDLE_SRE       =  94,
	DSI_PANEL_IE_SET_STRONG_SRE       =  96,
	DSI_PANEL_IE_SET_CLOSE_SRE        = 178,
	DSI_PANEL_IE_SET_COLOR_ENABLE     = 180,
	DSI_PANEL_IE_HBM_ENABLE           = 190,
	DSI_PANEL_IE_HBM_DISABLE          = 191,
	DSI_PANEL_IE_CGM_P3               = 200,
	DSI_PANEL_IE_CGM_SRGB             = 201,
	DSI_PANEL_IE_CGM_NATIVE           = 202,
	TOUCHSCREEN_SET_GLOVE_DISABLE     = 260,
	TOUCHSCREEN_SET_GLOVE_ENABLE      = 261,
};
...
extern int fts_glove_mode_set(u8 value);
#endif /* _DSI_PANEL_H_ */
