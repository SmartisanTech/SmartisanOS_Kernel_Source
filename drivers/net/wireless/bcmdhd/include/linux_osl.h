...
#ifndef errprintf
#define	errprintf(fmt, args...)	printk(KERN_WARNING "Wlan[E]: "fmt , ## args)
#endif

#ifndef wrnprintf
#define	wrnprintf(fmt, args...)	printk(KERN_WARNING "Wlan[W]: "fmt , ## args)
#endif

#ifndef printf
#define	printf(fmt, args...)	printk(KERN_INFO "Wlan[I]: "fmt , ## args)
#endif
#include <linux/kernel.h>	/* for vsn/printf's */
#include <linux/string.h>	/* for mem*, str* */
