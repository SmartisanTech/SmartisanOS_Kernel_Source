...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	int roam_trigger_2g[2] = {CUSTOM_ROAM_TRIGGER_SETTING_2G, WLC_BAND_2G};
	int roam_delta_2g[2] = {CUSTOM_ROAM_DELTA_SETTING_2G, WLC_BAND_2G};

	int roam_trigger_5g[2] = {CUSTOM_ROAM_TRIGGER_SETTING_5G, WLC_BAND_5G};
	int roam_delta_5g[2] = {CUSTOM_ROAM_DELTA_SETTING_5G, WLC_BAND_5G};
	...
	if ((ret = dhd_wl_ioctl_cmd(dhd, WLC_SET_ROAM_TRIGGER, roam_trigger_2g,
		...
		DHD_ERROR(("%s: roam trigger 2G set failed %d\n", __FUNCTION__, ret));

	if ((ret = dhd_wl_ioctl_cmd(dhd, WLC_SET_ROAM_TRIGGER, roam_trigger_5g,
		sizeof(roam_trigger_5g), TRUE, 0)) < 0)
		DHD_ERROR(("%s: roam trigger 5G set failed %d\n", __FUNCTION__, ret));

	if ((ret = dhd_wl_ioctl_cmd(dhd, WLC_SET_ROAM_SCAN_PERIOD, roam_scan_period,
		sizeof(roam_scan_period), TRUE, 0)) < 0)
		DHD_ERROR(("%s: roam scan period set failed %d\n", __FUNCTION__, ret));

	if ((dhd_wl_ioctl_cmd(dhd, WLC_SET_ROAM_DELTA, roam_delta_2g,
		sizeof(roam_delta_2g), TRUE, 0)) < 0)
		DHD_ERROR(("%s: roam delta 2G set failed %d\n", __FUNCTION__, ret));

	if ((dhd_wl_ioctl_cmd(dhd, WLC_SET_ROAM_DELTA, roam_delta_5g,
		sizeof(roam_delta_5g), TRUE, 0)) < 0)
		DHD_ERROR(("%s: roam delta 5G set failed %d\n", __FUNCTION__, ret));
...
static void dhd_hang_process(void *dhd_info, void *event_info, u8 event)
{
	...
	DHD_ERROR(("%s: please check hang reason\n", __FUNCTION__));
