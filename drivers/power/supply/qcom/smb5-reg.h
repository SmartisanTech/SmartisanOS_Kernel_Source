...
#define CHGR_SAFETY_TIMER_ENABLE_CFG	(CHGR_BASE + 0xA0)
...
#define HVDCP_PULSE_COUNT_QC3P0_MASK           GENMASK(5, 0)
...
#define DETECTED_SRC_DAM_MASK			GENMASK(6, 4)
...
#define TYPEC_VBUS_STATUS			BIT(5)
