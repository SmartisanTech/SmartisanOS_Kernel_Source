...
#ifdef CONFIG_SMARTISAN_COLOMBO
	...
	if (mi2s_bit_format == SNDRV_PCM_FORMAT_S24_LE) {
		switch (sample_rate) {
			...
			case SAMPLING_RATE_8KHZ:
				...
				break;
			case SAMPLING_RATE_44P1KHZ:
				bit_clock = Q6AFE_LPASS_IBIT_CLK_DISABLE;
				break;
			default:
				bit_clock = Q6AFE_LPASS_IBIT_CLK_3_P072_MHZ;
		}
...
static const struct snd_kcontrol_new msm_snd_controls[] = {
	...
	SOC_ENUM_EXT("SEC_MI2S_RX Channels", msm8996_mi2s_snd_enum[2],
			msm_sec_mi2s_rx_ch_get, msm_sec_mi2s_rx_ch_put),
	SOC_ENUM_EXT("SEC_MI2S_TX Channels", msm8996_mi2s_snd_enum[3],
	...
	SOC_ENUM_EXT("TERT_MI2S_RX Channels", msm8996_mi2s_snd_enum[4],
