...
static int meminfo_proc_show(struct seq_file *m, void *v)
{
	...
	show_val_kb(m, "LostMem:        ", i.totalram - i.freeram - i.bufferram - pages[LRU_ACTIVE_ANON]
		    ...
		    - ((global_zone_page_state(NR_KERNEL_STACK_KB)) >> (PAGE_SHIFT - 10)) - global_zone_page_state(NR_PAGETABLE)
		    - (d.system_alloc>>PAGE_SHIFT) - (d.cached>>PAGE_SHIFT) - gfx_page_alloc - gfx_cached - zram_phy_used);
