...
static int umount_user_request = 0;
...
void flush_delayed_mntput(void)
{
	delayed_mntput(NULL);
}
...
int getuserrequest_umount(void)
{
    return umount_user_request;
}

static void setuserrequest_umount(void)
{
    umount_user_request = 1;
}
